...
local LAYOUT_DEFAULTS = {
    ...
    comicPops  = false,  -- master switch for comic splashes on new records (off by default; opt in)
    comicRandom = false, -- "random art on every crit" mode (vs. per-slot record triggers)
